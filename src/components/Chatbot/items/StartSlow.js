...
export default function StartSlow(props) {
    ...
    return (
        <div>
            <button className='start-btn' onClick={() => preference("SEDAN")}>SEDAN</button>
            <button className='start-btn slow-btn' onClick={() => preference("SUV")}>SUV</button>
            <button className='start-btn slow-btn' onClick={() => preference("EV")}>EV</button>
        </div >
    )
}
